...
class Surface(pydantic.BaseModel):
    ...
    xCoordinate: list[float] = pydantic.Field(..., example=[1, 2, 3])
    yCoordinate: list[float] = pydantic.Field(..., example=[1, 2, 3])
    zCoordinate: list[float] = pydantic.Field(..., example=[1, 2, 3])
